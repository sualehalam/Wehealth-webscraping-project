...
| name | url | site_page | type | robots_ok | last_checked | refresh_strategy | expected_content | data_quality_notes | contact | example_selector | status |
|---|---|---|---|---|---|---|---|---|---|---|---|
...
| Alpine County Health & Human Services | https://www.alpinecountyca.gov/552/Health-Human-Services | /552/Health-Human-Services | county_page | needs-review | 2025-11-29T11:46:23Z | quarterly | phones;addresses | Footer blob produced an uncertain address; requires manual review to extract canonical address |  | `.footer, .contact-info` | needs-review |
...
If you want, I can also generate a machine-readable CSV `data/source_catalog.csv` with the same rows so it can be ingested by automated workflows. Would you like that?
```markdown
# Source Catalog
